...
(function() {
  ...
  module.exports = MultiWallet = (function() {
    var NETWORKMAP, getNode, getPublicNode;
    ...
    getPublicNode = function(arg, network) {
      if (arg instanceof HDNode) {
        return arg;
      } else if (typeof arg === 'string') {
    ...
    function MultiWallet(options) {
      ...
      if ('public' in options) {
        ...
        for (name in ref) {
          arg = ref[name];
          this.publicTrees[name] = this.trees[name] = getPublicNode(arg, this.network);
        }
      }
    }
    ...
    MultiWallet.prototype.signAllInputs = function(paths, txb) {
      ...
      inputs.forEach((function(_this) {
        return function(input, index) {
          ...
          signature = txb.inputs[index].signatures.filter(function(sig) {
            return sig !== void 0;
          })[0];
